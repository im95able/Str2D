...
The second motivation was this paper which explained to me the inadequacy of data structures which utilize many single node allocations(e.g. `std::set` and like).
